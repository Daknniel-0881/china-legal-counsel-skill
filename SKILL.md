...
- Use the bundled local knowledge base at `knowledge-base/` inside this skill. Resolve it as `/Users/suze/.codex/skills/china-legal-counsel/knowledge-base` in this local install.
